...
AppId={{939BED1D-9E07-4795-B455-E9238E7CC68D}

; Standard app data stuff
; !!NOTE!!: Replace all instances of "TheLastDefender" with your game name.
AppName=TheLastDefender
AppVerName=TheLastDefender Version 0.1
...
DefaultDirName={pf}\DigiPen\TheLastDefender

; Start menu directory
DefaultGroupName=DigiPen\TheLastDefender

; Output directory for the installer.
OutputDir=.\INSTALLER

; Setup executable installer
OutputBaseFilename=TheLastDefender_Setup
...
;
; I recommend placing any installers for required stuff (DirectX, PhysX, etc)s
...
[Icons]
Name: {group}\TheLastDefender; Filename: {app}\TheLastDefender.exe; WorkingDir: {app}; IconFilename: "{app}\Icon.ico"
Name: {group}\{cm:UninstallProgram,TheLastDefender}; Filename: {uninstallexe}
Name: {group}\{cm:UninstallProgram,TheLastDefender}; Filename: {uninstallexe};  IconFilename: "{app}\Icon.ico"
Name: {commondesktop}\TheLastDefender; Filename: {app}\TheLastDefender.exe; Tasks: desktopicon; WorkingDir: {app}; IconFilename: "{app}\Icon.ico"
...
Filename: {app}\TheLastDefender.exe; Description: {cm:LaunchProgram,TheLastDefender}; Flags: nowait postinstall skipifsilent


;To be able to run and generate the TheLastDefender_Setup.exe you need to download and install "Inno Setup" application, then open this file with the application.